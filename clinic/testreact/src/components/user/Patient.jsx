...
function Patient() {
    ...
    const handleFormSubmit = (event) => {
        ...
        axios.post(`${backendUrl}/Patient/CancelReservation`, dataToSend)
            .then(response => {
    ...
    useEffect(() => {
        async function fetchAppointments() {
            try {
                const response = await fetch(`${backendUrl}/Patient/AllReservation`); // Replace with your API endpoint
                if (!response.ok) {
    ...
    const handleShowSlots = async () => {
        try {
            const response = await fetch(`${backendUrl}/Patient/Getslot`, {
                method: 'GET',
                headers: {
    ...
    const handleFormCreate = (event) => {
        ...
        axios.post(`${backendUrl}/Patient/ReserveAppointment`, dataToSend)
            .then(response => {
                console.log(response.data);
                setTimeout(() => {
    ...
    const handleFormSubmitDoc = (event) => {
        ...
        axios.post(`${backendUrl}/Patient/UpdateReservation/Doctor`, dataToSend)
            .then(response => {
                console.log(response.data);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    const handleFormSubmitSlot = (event) => {
        ...
        axios.post(`${backendUrl}/Patient/UpdateReservation/Slot`, dataToSend)
            .then(response => {
                console.log(response.data);
                setTimeout(() => {
